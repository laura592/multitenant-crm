...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware): void {
        // Globale e non nel gruppo "web": il pannello Filament ha una sua
        // lista di middleware (AdminPanelProvider::panel()) che del gruppo
        // web non prende niente, e le intestazioni servono anche li'.
